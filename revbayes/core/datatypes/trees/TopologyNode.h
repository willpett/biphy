...
public:
    ...
    std::string                                 getBranchParameter(std::string) const;
...
//        size_t                                      getNodeFieldNumber() const;
    ...
    void                                        getTaxa(std::vector<std::string> &taxa) const;                                            //!< Fill the vector of taxa
    const std::string&                          getTaxon() const;                                                                   //!< Fill the vector of taxa
    ...
    void                                        setTaxon(std::string const &t);                                                           //!< Set the taxon of this node
...
protected:
    ...
    std::string                                 taxon;                                                                              //!< Taxon of the node, i.e. identifier/taxon name, plus species it comes from
