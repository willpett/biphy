...
namespace RevBayesCore {
    ...
    private:
        ...
        DiscreteCharacterData<StandardState>*       createStandardMatrix(NxsCharactersBlock* charblock);                        //!< Create an object to hold RNA data
        ...
        void                                        formatError(RbFileManager& fm, std::string& errorStr);                        //!< Attempt to determine the type of data
