/**
 * @file
 * This file contains the implementation of FileManager, which 
 * handles the opening, closing, testing presence of, etc. files.
 *
 * @brief Declaration of FileManager
 *
 * (c) Copyright 2009-
...
FileManager::FileManager(std::string s) 
{
...
std::string FileManager::findCurrentDirectory(void) 
{
...
bool FileManager::parsePathFileNames(std::string s) 
{
...
void FileManager::setCurrentDirectory(std::string const &s)
{
    curDirectory = s;
}
...
bool FileManager::setStringWithNamesOfFilesInDirectory(std::vector<std::string>& sv) 
{
...
bool FileManager::setStringWithNamesOfFilesInDirectory(const std::string& dirpath, std::vector<std::string>& sv) {
