...
template <class mixtureType>
MixtureDistribution<mixtureType>::MixtureDistribution(const TypedDagNode<std::vector<mixtureType> > *v, const TypedDagNode<std::vector<double> > *p) : TypedDistribution<mixtureType>( new mixtureType( v->getValue()[0]) ), parameterValues( v ), probabilities( p ), index( 0 ) {
...
template <class mixtureType>
MixtureDistribution<mixtureType>::MixtureDistribution(const MixtureDistribution<mixtureType> &n) : TypedDistribution<mixtureType>( n ), parameterValues( n.parameterValues ), probabilities( n.probabilities ), index( n.index ) {
...
template <class mixtureType>
MixtureDistribution<mixtureType>* MixtureDistribution<mixtureType>::clone( void ) const {
...
template <class mixtureType>
double MixtureDistribution<mixtureType>::computeLnProbability( void ) {
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::getAffected(std::set<DagNode *> &affected, DagNode* affecter) {
...
template <class mixtureType>
size_t MixtureDistribution<mixtureType>::getCurrentIndex( void ) const {
    return index;
}


template <class mixtureType>
size_t MixtureDistribution<mixtureType>::getNumberOfCategories( void ) const {
    return probabilities->getValue().size();
}


template <class mixtureType>
const std::vector<mixtureType>& MixtureDistribution<mixtureType>::getParameterValues( void ) const {
    return parameterValues->getValue();
}

template <class mixtureType>
void MixtureDistribution<mixtureType>::keepSpecialization( DagNode* affecter ) {
...
template <class mixtureType>
const mixtureType& MixtureDistribution<mixtureType>::simulate() {
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::redrawValue( void ) {
    *(this->value) = simulate();
}


template <class mixtureType>
void MixtureDistribution<mixtureType>::setCurrentIndex(size_t i) {
    index = i;
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::swapParameter(const DagNode *oldP, const DagNode *newP) {
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::restoreSpecialization( DagNode *restorer ) {
    // only do this when the toucher was our parameters
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::setValue(mixtureType const &v) {
...
template <class mixtureType>
void MixtureDistribution<mixtureType>::touchSpecialization( DagNode *toucher ) {
    // only do this when the toucher was our parameters
