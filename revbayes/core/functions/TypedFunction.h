...
template <class valueType>
std::ostream&                           operator<<(std::ostream& o, const TypedFunction<valueType>& x);
...
template <class valueType>
TypedFunction<valueType>::TypedFunction(valueType *v, std::string revDecl) : Function(),
    dagNode( NULL ), 
    value( v ), 
    dirty(true),
...
template <class valueType>
TypedFunction<valueType>::TypedFunction(const TypedFunction &f) : Function(f), 
    dagNode( NULL ), 
...
template <class valueType>
TypedFunction<valueType>::~TypedFunction( void ) {
...
template <class valueType>
TypedFunction<valueType>& TypedFunction<valueType>::operator=(const TypedFunction &f) {
...
template <class valueType>
const std::string& TypedFunction<valueType>::getRevDeclaration(void) const
{
...
template <class valueType>
const valueType& TypedFunction<valueType>::getValue(void) const 
{
...
template <class valueType>
valueType& TypedFunction<valueType>::getValue(void) 
{
...
template <class valueType>
void TypedFunction<valueType>::setDeterministicNode(DeterministicNode<valueType> *n) 
{
...
template <class valueType>
std::ostream& operator<<(std::ostream& o, const TypedFunction<valueType>& f) 
{
