...
template<class valueType>
DeterministicNode<valueType>::DeterministicNode( const std::string &n, TypedFunction<valueType> *f ) : DynamicNode<valueType>( n ), function( f ) {
...
template<class valueType>
DeterministicNode<valueType>::DeterministicNode( const DeterministicNode<valueType> &n ) : DynamicNode<valueType>( n ), function( n.function->clone() ) {
 ...
 */
template<class valueType>
void DeterministicNode<valueType>::getAffected(std::set<DagNode *> &affected, DagNode* affecter) {
...
template<class valueType>
TypedFunction<valueType>& DeterministicNode<valueType>::getFunction( void ) {
...
template<class valueType>
const TypedFunction<valueType>& DeterministicNode<valueType>::getFunction( void ) const {
    
    return *function;
}

template<class valueType>
double DeterministicNode<valueType>::getLnProbability( void ) {
...
template<class valueType>
double DeterministicNode<valueType>::getLnProbabilityRatio( void ) {
...
template<class valueType>
valueType& DeterministicNode<valueType>::getValue( void ) {
...
template<class valueType>
const valueType& DeterministicNode<valueType>::getValue( void ) const {
...
template<class valueType>
bool DeterministicNode<valueType>::isConstant( void ) const {
 ...
 */
template<class valueType>
void DeterministicNode<valueType>::keepMe( DagNode* affecter ) {
...
template <class valueType>
void DeterministicNode<valueType>::update() {
...
template<class valueType>
void DeterministicNode<valueType>::redraw( void ) {
    // nothing to do
...
template<class valueType>
void DeterministicNode<valueType>::restoreMe( DagNode *restorer ) {
...
template <class valueType>
void DeterministicNode<valueType>::swapParameter(const DagNode *oldP, const DagNode *newP) {
...
template<class valueType>
void DeterministicNode<valueType>::touchMe( DagNode *toucher ) {
