...
template<class valueType>
ConstantNode<valueType>::ConstantNode(const std::string &n, valueType *v) : TypedDagNode<valueType>( n ), value( v ) {
...
template<class valueType>
ConstantNode<valueType>::ConstantNode(const ConstantNode<valueType> &c) : TypedDagNode<valueType>( c ), value( Cloner<valueType, IsDerivedFrom<valueType, Cloneable>::Is >::createClone( *c.value ) ) {
...
template<class valueType>
ConstantNode<valueType>::~ConstantNode( void ) {
...
template<class valueType>
ConstantNode<valueType>* ConstantNode<valueType>::clone( void ) const {
...
template<class valueType>
DagNode* ConstantNode<valueType>::cloneDAG( std::map<const DagNode*, DagNode* >& newNodes ) const {
 ...
 */
template<class valueType>
void ConstantNode<valueType>::getAffected(std::set<DagNode *> &affected, DagNode* affecter) {
    
    // do nothing
    throw Exception("You should never call getAffected() of a constant node!!!");
    
}


template<class valueType>
double ConstantNode<valueType>::getEntireLnLikelihood( void ) {
...
template<class valueType>
double ConstantNode<valueType>::getLnProbability( void ) {
...
template<class valueType>
double ConstantNode<valueType>::getLnProbabilityRatio( void ) {
...
template<class valueType>
valueType& ConstantNode<valueType>::getValue( void ) {
...
template<class valueType>
const valueType& ConstantNode<valueType>::getValue( void ) const {
...
template<class valueType>
bool ConstantNode<valueType>::isConstant( void ) const {
...
template<class valueType>
void ConstantNode<valueType>::keepMe( DagNode* affecter ) {
    // nothing to do
}
...
void ConstantNode<valueType>::printStructureInfo(std::ostream &o) const 
{
...
template<class valueType>
void ConstantNode<valueType>::redraw( void ) {
    // nothing to do
}


template<class valueType>
void ConstantNode<valueType>::restoreMe( DagNode *restorer ) {
    // nothing to do
}


template<class valueType>
void ConstantNode<valueType>::setValue(valueType const &v) {
...
template<class valueType>
void ConstantNode<valueType>::swapParameter(const DagNode *oldP, const DagNode *newP) {
    // nothing to do
}


template<class valueType>
void ConstantNode<valueType>::touchMe( DagNode *toucher ) {
    // nothing to do
}
