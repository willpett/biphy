...
template<class firstValueType, class secondValueType, class returnType>
BinaryDivision<firstValueType, secondValueType, returnType>::BinaryDivision(const TypedDagNode<firstValueType> *l, const TypedDagNode<secondValueType> *r) : TypedFunction<returnType>( new returnType() ), a( l ), b( r ) {
    this->addParameter( l );
    this->addParameter( r );
...
template<class firstValueType, class secondValueType, class returnType>
BinaryDivision<firstValueType, secondValueType, returnType>* BinaryDivision<firstValueType, secondValueType, returnType>::clone( void ) const {
    return new BinaryDivision(*this);
}

template<class firstValueType, class secondValueType, class returnType>
void BinaryDivision<firstValueType, secondValueType, returnType>::swapParameterInternal(const DagNode *oldP, const DagNode *newP) {
    if (oldP == a) {
...
template<class firstValueType, class secondValueType, class returnType>
void BinaryDivision<firstValueType, secondValueType, returnType>::update( void ) {
