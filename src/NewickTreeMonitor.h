...
namespace RevBayesCore {
    ...
    public:
        ...
        NewickTreeMonitor(TypedDagNode<BranchLengthTree> *t, int g, const std::string &fname, bool ap=false);
        NewickTreeMonitor(TypedDagNode<BranchLengthTree> *t, const std::set<TypedDagNode<std::vector<double> > *> &n, int g, const std::string &fname, bool ap=false);                                              //!< Constructor with set of DAG node
