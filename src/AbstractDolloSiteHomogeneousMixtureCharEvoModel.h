#ifndef AbstractDolloSiteHomogeneousMixtureCharEvoModel_H
#define AbstractDolloSiteHomogeneousMixtureCharEvoModel_H
...
namespace RevBayesCore {
    ...
    class AbstractDolloSiteHomogeneousMixtureCharEvoModel : public TypedDistribution< AbstractCharacterData >, public TreeChangeEventListener {
        
    public:
        // Note, we need the size of the alignment in the constructor to correctly simulate an initial state
        AbstractDolloSiteHomogeneousMixtureCharEvoModel(const TypedDagNode<treeType> *t, size_t nChars, size_t nMix, bool c, size_t nSites);
        AbstractDolloSiteHomogeneousMixtureCharEvoModel(const AbstractDolloSiteHomogeneousMixtureCharEvoModel &n);                                                                                          //!< Copy constructor
        virtual                                                            ~AbstractDolloSiteHomogeneousMixtureCharEvoModel(void);                                                              //!< Virtual destructor
        
        // public member functions
        // pure virtual
        virtual AbstractDolloSiteHomogeneousMixtureCharEvoModel*                 clone(void) const = 0;                                                                      //!< Create an independent clone
    ...
    protected:
        ...
        bool 																isAncestral( const TopologyNode &n, size_t site);
        ...
        std::vector<std::vector<bool> >                          			ancestralNodes;
...
template<class charType, class treeType>
RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::AbstractDolloSiteHomogeneousMixtureCharEvoModel(const TypedDagNode<treeType> *t, size_t nChars, size_t nMix, bool c, size_t nSites) : TypedDistribution< AbstractCharacterData >(  new DiscreteCharacterData<charType>() ),
    numSites( nSites ), 
    numChars( nChars ),
    numSiteRates( nMix ),
    tau( t ), 
...
template<class charType, class treeType>
RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::AbstractDolloSiteHomogeneousMixtureCharEvoModel(const AbstractDolloSiteHomogeneousMixtureCharEvoModel &n) : TypedDistribution< AbstractCharacterData >( n ),
    numSites( n.numSites ), 
    numChars( n.numChars ),
...
template<class charType, class treeType>
RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::~AbstractDolloSiteHomogeneousMixtureCharEvoModel( void ) {
...
template<class charType, class treeType>
RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>* RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::clone( void ) const
{
    
    return new AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>( *this );
}


template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::compress( void )
{
...
template<class charType, class treeType>
double RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::computeLnProbability( void )
{
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::fillLikelihoodVector(const TopologyNode &node, size_t nodeIndex)
{    
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::fireTreeChangeEvent( const RevBayesCore::TopologyNode &n ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::keepSpecialization( DagNode* affecter ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::recursivelyFlagNodeDirty( const RevBayesCore::TopologyNode &n ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::redrawValue( void ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::reInitialized( void ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::resizeLikelihoodVectors( void ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::restoreSpecialization( DagNode* affecter ) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::setValue(AbstractCharacterData *v) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::simulate( const TopologyNode &node, std::vector< DiscreteTaxonData< charType > > &taxa, const std::vector<size_t> &perSiteRates) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::swapParameter(const DagNode *oldP, const DagNode *newP) {
...
template<class charType, class treeType>
void RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::touchSpecialization( DagNode* affecter ) {
...
template<class charType, class treeType>
bool RevBayesCore::AbstractDolloSiteHomogeneousMixtureCharEvoModel<charType, treeType>::isAncestral( const RevBayesCore::TopologyNode &n, size_t site ) {
